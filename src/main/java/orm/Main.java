...
class Main {
    public static void main(String args[]) {
        SqlServer sqlServer = new SqlServer("root", "1111", "jdbc:mysql://localhost:3306");
        ...
        PersistenceConfig persistenceConfig =
                new PersistenceConfig(entityClasses, "root", "1111", "com.mysql.jdbc.Driver",
                                      "jdbc:mysql://localhost:3306/hibernateexercise");
